...
"use strict";
/* unused harmony export randomCoordinate */
...
/* harmony default export */ __webpack_exports__["a"] = randomCoordinate;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__locations_js__ = __webpack_require__(2);
/* harmony export (immutable) */ __webpack_exports__["conjure"] = conjure;
/* harmony export (immutable) */ __webpack_exports__["pointsToGeoJSON"] = pointsToGeoJSON;
...
function conjure(options) {
	...
	var points = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__locations_js__["a" /* randomPoints */])(options.bound, options.count);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__randomCoordinate__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__randomInPolygon__ = __webpack_require__(3);
...
function randomPoints(bound, count) {
	...
	for (var i = 0; i < count; i++) {
		arr.push(Array.isArray(bound) ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__randomCoordinate__["a" /* default */])(bound) : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__randomInPolygon__["a" /* default */])(bound));
	}
	return arr;
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__turf_inside__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__turf_inside___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__turf_inside__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapbox_extent__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapbox_extent___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__mapbox_extent__);
/* unused harmony export randomInPolygon */
...
function randomInPolygon(polygon) {
	...
	var point = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__randomCoordinate__["a" /* default */])(bbox);
	while (!__WEBPACK_IMPORTED_MODULE_2__turf_inside___default()(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__index_js__["pointsToGeoJSON"])([point])[0], polygon)) {
		point = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__randomCoordinate__["a" /* default */])(bbox);
	}return point;
}

function getPolygonExtent(polygon) {
	var coords = polygon.geometry.coordinates[0];
	var ext = __WEBPACK_IMPORTED_MODULE_3__mapbox_extent___default()();
...
/* harmony default export */ __webpack_exports__["a"] = randomInPolygon;
